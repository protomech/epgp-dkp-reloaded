...
L["A new tier is here!  You should probably reset or rescale GP (Interface -> Options -> AddOns -> EPGP)!"] = "Un nuevo Tier ha llegado! Deberias reiniciar o escalar los GP! (Interfaz -> Opciones -> AddOns -> EPGP)" -- Needs review
...
L["expected number"] = "numero esperado" -- Needs review
L["Export"] = "Exportar"
...
L["GP is rescaled for the new tier"] = "GP recortados para un nuevo Tier" -- Needs review
L["GP (not EP) is reset"] = "GP Reiniciados" -- Needs review
L["GP (not ep) reset"] = "Reinicio de GP" -- Needs review
L["GP on tooltips"] = "GP en las etiquetas"
L["GP Reason"] = "Razón de GP"
L["GP rescale for new tier"] = "Recorte de GP para nuevo Tier" -- Needs review
...
L["invalid input"] = "entrada invalida" -- Needs review
...
L["must be equal to or higher than %s"] = "tiene que ser igual o mayor que %s" -- Needs review
L["must be equal to or lower than %s"] = "tiene que ser igual o menor que %s" -- Needs review
L["Next award in "] = "Siguiente recompensa en"
L["off"] = "Off" -- Needs review
L["on"] = "On" -- Needs review
...
L["Redo"] = "Rehacer"
L["Re-scale all main toons' GP to current tier?"] = "Recortar GP de todos los personajes al nuevo Tier?" -- Needs review
L["Rescale GP"] = "Recortar GP" -- Needs review
...
L["'%s' - expected 'RRGGBBAA' or 'r g b a'."] = "'%s' - esperado 'RRGGBBAA' or 'r g b a'." -- Needs review
L["'%s' - expected 'RRGGBB' or 'r g b'."] = "'%s' - esperado 'RRGGBB' o 'r g b'." -- Needs review
L["Show everyone"] = "Mostrar a todos"
L["'%s' - Invalid Keybinding."] = "'%s' - Keybinding invalido." -- Needs review
...
L["'%s' '%s' - expected 'on' or 'off', or no argument to toggle."] = "'%s' '%s' -" -- Needs review
L["%s: %s to %s"] = "%s: %s a %s"
L["Standby"] = "En espera"
...
L["%s to %s"] = "%s a %s"
-- L["string1"] = ""
L["'%s' - values must all be either in the range 0-1 or 0-255."] = "'%s' - los valores deben estar en un rango de 0-1 o 0-255." -- Needs review
L["'%s' - values must all be either in the range 0..1 or 0..255."] = "'%s' - los valores deben estar en un rango de 0..1 o 0..255." -- Needs review
...
L["Undo"] = "Deshacer"
-- L["unknown argument"] = ""
L["unknown selection"] = "seleccion desconocida" -- Needs review
