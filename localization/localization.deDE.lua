...
L["Alts"] = "Zweitcharaktere" -- Needs review
L["A member is awarded EP"] = "Ein Mitglied hat EP erhalten"
L["A member is credited GP"] = "Einen Mitglied wurden GP angerechnet"
L["A new tier is here!  You should probably reset or rescale GP (Interface -> Options -> AddOns -> EPGP)!"] = "Es gibt eine neue Ausrüstungsstufe! Du solltet vielleicht alle GP-Werte zurücksetzen oder neu skalieren (Interface -> Optionen -> AddOns -> EPGP)!" -- Needs review
...
L["Announces EPGP actions to the specified medium."] = "Gibt EPGP-Aktionen an das angegebene Medium aus." -- Needs review
L["Announce when:"] = "Ankündigen wenn:"
L["Automatic boss tracking"] = "Automatisches Boss-Tracking"
L["Automatic boss tracking by means of a popup to mass award EP to the raid and standby when a boss is killed."] = "Automatisches Boss-Tracking bedeutet, daß nach einem Bosskill ein Popup erscheint, wo EP an alle im Schlachtzug und auf der Bereitschaftsliste vergeben werden kann" -- Needs review
...
L["expected number"] = "Nummer erwartet" -- Needs review
...
L["GP is rescaled for the new tier"] = "GP werden für die neue Ausrüstungsstufe umskaliert" -- Needs review
L["GP (not EP) is reset"] = "GP (nicht EP) werden zurückgesetzt" -- Needs review
L["GP (not ep) reset"] = "GP (nicht EP) zurücksetzen" -- Needs review
L["GP on tooltips"] = "GP in Tooltips"
L["GP Reason"] = "GP Grund"
L["GP rescale for new tier"] = "GP Umskalierung für neue Ausrüstungsstufe" -- Needs review
...
L["invalid input"] = "Fehlerhafte Eingabe" -- Needs review
...
L["must be equal to or higher than %s"] = "Muss gleich oder höher sein als %s" -- Needs review
L["must be equal to or lower than %s"] = "Muss gleich oder niedriger sein als %s" -- Needs review
L["Next award in "] = "Nächste Belohnung in"
L["off"] = "Deaktiviert" -- Needs review
L["on"] = "Aktiviert" -- Needs review
...
L["Other"] = "Anderes"
L["Outsiders should be 0 or 1"] = "Außenstehende (Outsiders) sollte 0 oder 1 sein." -- Needs review
...
L["Re-scale all main toons' GP to current tier?"] = "Alle GP Werte der Hauptcharaktere umskalieren?" -- Needs review
L["Rescale GP"] = "GP Umskalieren" -- Needs review
L["Rescale GP of all members of the guild. This will reduce all main toons' GP by a tier worth of value. Use with care!"] = "Umskalieren der GP aller Gildenmitglieder. Dies wird die GP aller Hauptcharaktere um den Wert einer Ausrüstungsstufe verringern. Mit Vorsicht verwenden!" -- Needs review
L["Reset all main toons' EP and GP to 0?"] = "EP und GP aller Hauptcharaktere auf 0 zurücksetzen?"
L["Reset all main toons' GP to 0?"] = "GP aller Hauptcharaktere auf 0 zurücksetzen?" -- Needs review
L["Reset EPGP"] = "EPGP zurücksetzen"
L["Reset only GP"] = "Nur GP zurücksetzen" -- Needs review
...
L["Resets GP (not EP!) of all members of the guild. This will set all main toons' GP to 0. Use with care!"] = "Setzt die GP (nicht EP!) aller Gildenmitglieder zurück. Dies wird die GP aller Hauptcharaktere auf 0 zurücksetzen. Mit Vorsicht verwenden!" -- Needs review
...
L["'%s' - expected 'on', 'off' or 'default', or no argument to toggle."] = "'%s' - \"on\", \"off\" oder \"default\" erwartet, oder kein Argument um zu wechseln." -- Needs review
L["'%s' - expected 'on' or 'off', or no argument to toggle."] = "'%s' - \"on\" oder \"off\" erwartet, oder kein Argument um zu wechseln." -- Needs review
L["'%s' - expected 'RRGGBBAA' or 'r g b a'."] = "'%s' - erwartet 'RRGGBBAA' oder 'r g b a'." -- Needs review
L["'%s' - expected 'RRGGBB' or 'r g b'."] = "'%s' - erwartet 'RRGGBB' oder 'r g b'." -- Needs review
L["Show everyone"] = "Zeige Alle"
L["'%s' - Invalid Keybinding."] = "'%s' - Ungültige Tastenbelegung" -- Needs review
...
L["Some english word"] = "Irgendein zufälliges Wort" -- Needs review
L["Some english word that doesn't exist"] = "Irgendein zufälliges Wort welches nicht existiert" -- Needs review
L["'%s' '%s' - expected 'on', 'off' or 'default', or no argument to toggle."] = "'%s' '%s' - \"on\", \"off\" oder \"default\" erwartet, oder kein Argument um zu wechseln." -- Needs review
L["'%s' '%s' - expected 'on' or 'off', or no argument to toggle."] = "'%s' '%s' - \"on\" oder \"off\" erwartet, oder kein Argument um zu wechseln." -- Needs review
L["%s: %s to %s"] = "%s: %s an %s"
...
L["%s to %s"] = "%s an %s"
L["string1"] = "Zeichenkette1" -- Needs review
L["'%s' - values must all be either in the range 0-1 or 0-255."] = "'%s' - Werte müssen innerhalb von 0-1 oder 0-255 liegen." -- Needs review
L["'%s' - values must all be either in the range 0..1 or 0..255."] = "'%s' - Werte müssen innerhalb von 0..1 oder 0..255 liegen." -- Needs review
...
L["unknown argument"] = "Unbekanntes Argument" -- Needs review
L["unknown selection"] = "Unbekannte Auswahl" -- Needs review
