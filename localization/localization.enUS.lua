...
L["Announces all EPGP actions to the specified medium."] = true
...
L["Provide a proposed GP value of armor on tooltips. Quest items or tokens that can be traded with armor will also have a proposed GP value."] = true
L["Recurring"] = true
L["Redo"] = true
L["Reset EPGP"] = true
...
L["To restore to an earlier version of the standings, copy and paste the text from the webapp: http://epgpweb.appspot.com here"] = true
L["Tooltip"] = true
L["Undo"] = true
