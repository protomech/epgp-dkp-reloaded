...
L["A new tier is here!  You should probably reset or rescale GP (Interface -> Options -> AddOns -> EPGP)!  Check the Firelands Release Notes for details (http://code.google.com/p/epgp/wiki/FirelandsReleaseNotes)"] = true
L["Alts"] = true
