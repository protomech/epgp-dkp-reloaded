...
L["Awards for wipes on bosses. Requires Deadly Boss Mods"] = "R\195\169compenses pour wipes sur les bosses.  Requi\195\168re Deadly Boss Mods."
...
L["GP: %d"] = "GP: %cl" -- Needs review
L["GP: %d [ItemLevel=%d]"] = "GP : %d [NiveauObjet=%d]"
L["GP: %d or %d"] = "GP: %d or %d" -- Needs review
...
L["%s: %s to %s"] = "a\
depends of the sentence" -- Needs review
...
L["Undo"] = "Annuler"
L["Using DBM for boss kill tracking"] = "Utiliser DBM pour suivre la mort des boss"
L["Value"] = "Valeur"
L["Whisper"] = "Chuchoter"
L["Wipe awards"] = "R\195\169compenses de wipe" -- Needs review
L["Wiped on %s. Award EP?"] = "Wipe sur %8. Attribuer EP?" -- Needs review
L["You cannot undo this action!"] = "Vous ne pouvez pas annuler cette action!"
L["You can now check your epgp standings and loot on the web: http://www.epgpweb.com"] = "Vous pouvez maintenant v\195\169rifier votre rang EPGP et loot sur le web: http://epgpweb.com" -- Needs review
