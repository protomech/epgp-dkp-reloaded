...
L["Decay"] = "Réduction"
L["Decay EP and GP by %d%%?"] = "Réduire les EP et les GP par %d%% ?"
L["Decay of EP/GP by %d%%"] = "Réduction d'EP/GP par %d%%"
...
-- L["off"] = ""
-- L["on"] = ""
L["Only display GP values for items at or above this quality."] = "Seulement afficher les valeurs GP pour les objets de cette qualité ou plus haute." -- Needs review
